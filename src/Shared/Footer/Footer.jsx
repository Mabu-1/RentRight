...
const Footer = () => {
    return (
        <footer className="w-full border-t-2 bg-gray-50 mabu-bg ">
            <div className="relative  bg-center bg-cover text-white px-6 py-12 md:px-16 lg:px-20 ">
                {/* Overlay */}
                ...
                <div className="relative flex flex-col lg:flex-row lg:justify-between lg:items-start gap-10">
                    ...
                    <div className="flex-1">
                        ...
                        <ul className="mt-4 space-y-2 text-black font-medium">
                            <li><Link className="hover:text-[#eb6838] mabu-text2 font-bold" to="/">Home</Link></li>
                            <li><Link className="hover:text-[#eb6838] mabu-text2 font-bold" to="/property">Property</Link></li>
                            <li><Link className="hover:text-[#eb6838] mabu-text2 font-bold" to="/service">Service</Link></li>
                            <li><Link className="hover:text-[#eb6838] mabu-text2 font-bold" to="/aboutUs">About Us</Link></li>
                            <li><Link className="hover:text-[#eb6838] mabu-text2 font-bold" to="/contactUs">Contact Us</Link></li>
                            <li><Link className="hover:text-[#eb6838] mabu-text2 font-bold" to="/login">Login</Link></li>
                            <li><Link className="hover:text-[#eb6838] mabu-text2 font-bold" to="/signup">Register</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="flex-1">
                        ...
                        <ul className="flex flex-col gap-4 mt-4 text-black font-bold">
                            <li className="flex gap-3 items-center">
                                ...
                                <p className='mabu-text2'>+8 (800) 238 9997</p>
                            </li>
                            <li className="flex gap-3 items-center">
                                <MdEmail className="text-red-600 text-xl md:text-2xl" />
                                <p className='mabu-text2'>rentright77@gmail.com</p>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="relative mt-10 border-t pt-4 text-center text-black font-semibold">
                    <p>
                        © <span className="text-[#ec6331]">RentRight</span> <span className='mabu-text2'>2024 | Created by{" "}</span>
                        <span className="font-bold mabu-text2">Mahtab Uddin</span>
                    </p>
                </div>
            </div>
        </footer>
