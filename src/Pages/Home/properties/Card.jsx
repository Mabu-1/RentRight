            ...
            <div className="w-full">
                ...
                <div className="p-3 sm:p-4 md:p-4 lg:p-4">
                    <div className="flex flex-col sm:flex-row justify-between">
                        ...
                        <h1 className="text-base sm:text-lg md:text-xl lg:text-lg font-bold mb-2 ">{condition}</h1>
                    </div>
                    <hr className="my-2" />
                    ...
                    <div className="flex justify-center">
                        <span className="text-base sm:text-lg md:text-xl lg:text-lg font-bold text-[#eb7043]">${price}</span>
                    </div>
                    <hr className="my-2" />
                    <div className="flex justify-center">
                        <Link to={`/property/${_id}`}>
                            <button
                                className="p-2 sm:p-2 md:p-3 lg:p-2 border rounded-lg bg-[#e98561] hover:bg-[#eb7043] font-bold hover:text-white"
