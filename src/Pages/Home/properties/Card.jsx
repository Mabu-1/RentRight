...
const Card = ({ Property }) => {
    const {name,imageURL,address,condition,price} =Property;
    ...
    return (
        <div className="border border-gray-300 rounded-lg shadow-lg overflow-hidden w-10/12 max-h-full" data-aos="fade-up">
            <div className="w-full">
                <img src={imageURL} alt={name} className="w-full h-[250px] object-cover z-0 relative" />
                <div className="p-4">
                  <div className="flex justify-between">
                      ...
                      <div>
                      <h1 className="text-2xl font-bold mb-2 text-blue-600">{condition}</h1>
