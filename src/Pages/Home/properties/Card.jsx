      ...
      <div className="w-full">
        ...
        <div className="p-3 sm:p-4 md:p-4 lg:p-4">
          <div className="flex flex-col sm:flex-row justify-between">
            <h1 className="text-base sm:text-lg md:text-xl lg:text-lg font-bold mb-2 text-orange-600 dark:text-orange-400">
              {name}
            </h1>
            <h1 className="text-base sm:text-lg md:text-xl lg:text-lg font-bold mb-2 dark:text-gray-300">
              {condition}
            </h1>
          </div>
          <hr className="my-2 border-gray-300 dark:border-gray-700" />
          <div className="text-center">
            <p className="font-semibold mb-2 text-sm sm:text-md">{address}</p>
          </div>
          <hr className="my-2 border-gray-300 dark:border-gray-700" />
          <div className="flex justify-center">
            <span className="text-base sm:text-lg md:text-xl lg:text-lg font-bold text-[#eb7043] dark:text-[#ffb366]">
              ${price}
            </span>
          </div>
          <hr className="my-2 border-gray-300 dark:border-gray-700" />
