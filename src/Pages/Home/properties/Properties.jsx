...
const Properties = () => {
  ...
  if (!filtered.length) return <div className="text-center text-gray-500 dark:text-gray-400">No Properties found.</div>;

  return (
    <div className="my-[100px]  text-gray-900 dark:text-gray-100">
      {/* Headline */}
