...
>>>>>>> 864ad4bea09fd6da8e4a510a02760f45e28ecb24
                ...
                />
<<<<<<< HEAD
                <p className="mt-2 text-gray-600 text-sm sm:text-base md:text-lg max-w-2xl mx-auto">
            ...
            <div className="flex flex-col-reverse md:flex-row items-center gap-8">
                ...
                >
                    ...
                    <ul className="space-y-3 text-gray-600 text-sm sm:text-base md:text-lg">
                        <li className="flex items-center gap-3">
                            <FaCheckCircle className="text-[#eb7043] text-lg sm:text-xl" />
