    ...
    return (
        <div className="my-7 p-8 max-w-4xl mx-auto bg-gray-100 rounded-lg shadow-lg">
            <div className="text-center mb-7">
                <h1 className="text-red-600 font-bold text-5xl">Create Service</h1>
            </div>
            <div className="p-6 bg-white rounded-b-lg">
                <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    ...
                    <button
                        type="submit"
                        className="col-span-2 bg-red-500 text-white p-3 rounded-lg font-bold hover:bg-red-700 transition duration-300"
                    >
                        Create Service
                    </button>
                </form>
