...
const PropertyInfo = () => {
  ...
  const handleBuyClick = () => {
    if (user) {
      navigate(`/propertyBuy/${property._id}`);
    } else {
      Swal.fire({
        title: 'Login Required',
        text: 'You need to be logged in to buy this property.',
        icon: 'warning',
      ...
      <div className="p-6 sm:p-10">
        ...
        <div className="flex justify-center gap-6">
          <button
            ...
            className="px-10 py-3 bg-gradient-to-r from-[#eb7043] to-[#f6a563] text-white font-bold text-lg sm:text-2xl rounded-full shadow-lg hover:scale-105 transition-all duration-300"
          >
            Buy Now
          </button>
        </div>
